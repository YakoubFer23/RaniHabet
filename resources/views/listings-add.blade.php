...
<div class="container">
    ...
    <form action="{{ route('listings.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" placeholder="Provide a title for your listing" name="title" id="title" class="form-control" required>
            @error('title')
        ...
        <div class="mb-3">
            ...
            <textarea name="description" placeholder="Provide a description for your listing" id="description" class="form-control" rows="5" required></textarea>
            @error('description')
                <span class="text-danger fs-6">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" placeholder="It doesn't have to be precise, a general area will suffice" name="address" id="address" class="form-control" required>
            @error('address')
                <span class="text-danger fs-6">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" placeholder="How long is it available for" name="duration" id="duration" class="form-control"
                required>
                @error('duration')
                <span class="text-danger fs-6">{{$message}}</span>
            @enderror
