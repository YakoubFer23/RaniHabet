                    ...
                    <div class="row g-2">
                        <div class="col-md-8">
                            <input type="text" name="query" class="form-control border-0 py-3"
                                placeholder="Search by city or state (For state search please enter the state code)">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
            ...
            <div class="col-lg-5 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                    <li class="nav-item me-2">
                        <a class="btn btn-outline-primary active" data-bs-toggle="pill" href="#tab-1">Appartments</a>
                    </li>
                    <li class="nav-item me-2">
                        <a class="btn btn-outline-primary" data-bs-toggle="pill" href="#tab-2">Rooms</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                @if ($listings->isNotEmpty())
                    ...
                    <div class="row g-4">
                        ...
                        <div class="d-flex justify-content-center wow fadeInUp" data-wow-delay="0.1s">
                            {{ $listings->appends(['query' => request('query')])->links() }}
                        </div>
